...
# ====         ================                       ======================
# 15-May-23     Michael Nunez      Conversion from single_trial_alpha_dc.py
...
def diffusion_trial(drift, mu_alpha, beta, ter, var_alpha, dc, sigma1, 
    ...
    temp_extdata1 = np.random.normal(1*bound_trial, sigma1)
    
    mu_extdata1 = 1*mu_alpha
    var_extdata1 = var_alpha**2 + sigma1**2
