...
# ====         ================                       ======================
# 20-June-23     Michael Nunez      Conversion from single_trial_alpha_not_scaled.py
# 21-June-23     Michael Nunez            Fixes to last test case simulation
...
def draw_prior():
    ...
    # gamma ~ U(0.0, 1.0), effect of single-trial boundary on extdata1, index 6
