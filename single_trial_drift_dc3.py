...
#      with a better truncated normal for single-trial DC and better priors
...
model_name = 'single_trial_drift_dc3'
...
def draw_prior():
    ...
    # gamma_dr1 ~ N(0, 1.0), Effect of single-trial drift rate on EEG1
    gamma_dr1 = RNG.normal(0.0, 1.0)
    ...
    # gamma_dc2 ~ N(0, 1.0), Effect of single-trial diffusion coefficient on EEG2
    gamma_dc2 = RNG.normal(0.0, 1.0)
    ...
    p_samples = np.hstack((mu_drift, alpha, beta, ter, eta, mu_dc, var_dc, gamma_dr1, gamma_dc1,
