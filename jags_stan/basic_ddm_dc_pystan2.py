# basic_ddm_dc_pystan.py - Testing JAGS fits of a non-hierarchical DDM model with diffusion coefficient in Stan using pystan 2 in Python 3
#
...
# Online references
# https://pystan.readthedocs.io/en/latest/index.html vs https://pystan2.readthedocs.io/en/latest/getting_started.html
...
plot_path = f"new_figures/basic_ddm_dc_pystan2"
